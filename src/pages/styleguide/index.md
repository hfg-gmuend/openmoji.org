...
![Emoji 13.0](assets-styleguide/emoji13.svg)
...
![Comparison polar bear emoji before and after redesign](assets-styleguide/emojidesign.png)
...
![Example of how other emoji libraries influence the OpenMojis](assets-styleguide/consistency.svg)
...
![The full grid](assets-styleguide/grid.svg)
...
![The different types of contours and cornes: Round caps, round edges and centered contour](assets-styleguide/contour.svg)

#### Open Contour
The open contours result in a nice dynamic look and should be used for overlapping lines or perspective.

![Two examples showing the open contour](assets-styleguide/open-contour.svg)

#### Contour and Fill
The fill should continue as if the contour was still there

![Two examples the expected fill style](assets-styleguide/open-contour-color.svg)
...
![Example for dos and don'ts regarding perspective](assets-styleguide/perspective.svg)
...
![Two examples showing the shading](assets-styleguide/shadows.svg)
...
![A sample of the custom openmoji font](assets-styleguide/typography.svg)

### Topics
#### People
![Multiple examples of people-emojis](assets-styleguide/people.svg)
...
![Examples of full body emojis](assets-styleguide/full-body.svg)
...
![Examples of emoji where only the bust is visible](assets-styleguide/bust.svg)

##### Hands
The thumb converges slightly at the end. The lower side of the hand is rounded. Fingers have a width of 7px.

![Examples of hand-emojis](assets-styleguide/hands.svg)

#### Arrows
The arrow head is made out of one basic form.

![Examples of arrow-emojis](assets-styleguide/arrows.svg)
...
![Example of how to translate from a double line emoji to a single line emoji](assets-styleguide/arrows-2.svg)

#### Buildings
Buildings are shown **from the front** with an entrance door. Details should be reduced strongly.

![Examples of buildings](assets-styleguide/buildings.svg)
...
![Examples of animal-emojis and plant-emojis](assets-styleguide/plants-animals.svg)
...
![Examples of vehicle-emojis](assets-styleguide/vehicles.svg)
...
![Screenshot of Adobe Illustrator with the correct layers](assets-styleguide/submission-layer-structure.png)
...
![Explanation on how to structure the file](assets-styleguide/bicycles.svg)
...
![Explanation on how to structure the file](assets-styleguide/explodinghead.svg)
...
![Screenshot from Adobe Illustrator with the correct export settings](assets-styleguide/Export.png)
...
![Screenshots from Inkscape with the correct export settings](assets-styleguide/ExportInkscape.png)
...
![Screenshot from Figma with the correct export settings](assets-styleguide/ExportFigma.png)
